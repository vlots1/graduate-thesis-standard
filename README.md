...
```text
请用 graduate-thesis-standard 帮我准备教育学硕士论文的中文摘要写作要求。
```

### 修改结果部分前

```text
我正在修改特殊教育博士论文的结果部分。请先列出当前必须遵守的学校要求，不要改动任何统计结果。
```
...
本仓库目前未附带许可证。公开发布前，请由维护者决定并添加适合的 `LICENSE` 文件；在此之前，他人通常没有明确的复制、修改和再发布授权。
